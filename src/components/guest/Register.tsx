      ...
      <div className="row gy-3 overflow-hidden">
        <div className="col-12">
          <div className="form-floating mb-1">
            <input type="text"
                   onChange={e => setFirstName(e.target.value.trim())} className="form-control border-2"
                   name="name" id="name"
        ...
        <div className="col-12">
          <div className="d-grid">
            <button onClick={handleClickRegister} className="btn bsb-btn-3xl btn-primary py-3" type="submit">Register
            </button>
          </div>
        </div>
      </div>
